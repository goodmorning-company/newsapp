...
A Flutter-based editorial showcase application that demonstrates clean architecture, high-impact UI/UX, AI-assisted journalism, and real-time Firebase integration.
...
You must provide your OpenAI API key at runtime using `--dart-define`.

```bash
flutter run --dart-define=EDITORIAL_AI_KEY=sk-pro-YOUR_OPENAI_API_KEY
```

> ⚠️ Replace `sk-pro-YOUR_OPENAI_API_KEY` with your own OpenAI API key.

---

## 🧠 Project Description

This project is an **editorial-focused Flutter application** designed to feel like a real, premium digital publication rather than a simple technical demo.

It combines:
- Clean Architecture
- Predictable state management
- Firebase-backed publishing
- AI-assisted editorial workflows
- High-impact, magazine-style UI/UX

The goal is to demonstrate **end-to-end product thinking**, from splash screen to publishing and reading experiences.
...
▶️ **[Watch Full App Showcase](./report/videos/videoshowcase.webm)**
...
▶️ **[Watch AI Feature Demo](./report/videos/aifeature.webm)**
...
<p align="center">
  <img src="./report/screenshots/home_screen.png" width="325" alt="Home Feed"/>
</p>
...
<p align="center">
  <img src="./report/screenshots/read_article.png" width="325" alt="Article Reading Experience"/>
</p>
...
<p align="center">
  <img src="./report/screenshots/markdown.png" width="325" alt="Markdown Rendering"/>
</p>
...
<p align="center">
  <img src="./report/screenshots/normalformat.png" width="325" alt="Standard Article Format"/>
  &nbsp;&nbsp;
  <img src="./report/screenshots/iaformat.png" width="325" alt="AI Enhanced Article Format"/>
</p>
...
<p align="center">
  <img src="./report/screenshots/lightmode.png" width="325" alt="Light Mode"/>
</p>
...
<p align="center">
  <img src="./report/screenshots/splash_screen.png" width="325" alt="Splash Screen"/>
</p>
